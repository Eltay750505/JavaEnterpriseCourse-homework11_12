...
public class ConnectionRepositoryImpl implements ru.mail.romanov1234567890987.repository.ConnectionRepository {
    private static final Logger logger = LogManager.getLogger(MethodHandles.lookup().lookupClass());
    private static ru.mail.romanov1234567890987.repository.ConnectionRepository instance;

    private ConnectionRepositoryImpl() {
    }

    public static ru.mail.romanov1234567890987.repository.ConnectionRepository getInstance() {
        if (instance == null) {
